...
function Homepage() {
    ...
    return (
        <div className='row' style={{height:400, backgroundColor:'white', top:'10px', margin:'5px 5px 5px 10px', padding:'5px 5px 5px 5px', maxWidth:'100%'}}>

            <div className='col-md-3'style={{width:'47%', backgroundImage:'linear-gradient(lightgray, white)', position: 'relative', bottom:'-30px',height:'98%', boxShadow:'-25px 25px 10px', float:'right'}}>

                <article style={{backgroundImage:'linear-gradient(lightgray, white)',marginRight:'0px',marginLeft:'0px',
                    padding:'1.6px', minWidth:'500px',fontSize:'16px', maxHeight:'350px', position:'relative', zIndex:'4px', overflow:'scroll'}}>

                        <h4 id='homepage' style={{fontFamily:'Dancing Script', fontSize:'30px', textAlign:'center', fontWeight:'bold'}}>How dod i got here?!?</h4>
                        <p style={{fontFamily:'Satisfy', textAlign:'center',fontSize:'22px'}}>Well let’s start from the beginning.
                            <br></br>
                            Hi, My name is Mario.
                        </p>
                        <p style={{fontFamily:'Satisfy', fontSize:'20px'}}> I am  Web Developer leveraging a background in IT mainly  Networking.  Recently I’ve joined Development field as I’m finishing Bootcamp  for  <b>Full Stack Development from Rutgers University.</b> With newly developed skills and certification in JavaScript, Bootstrap, jQuery, MySQL, MongoDB, Sequelize, ORM, Heroku, Node.js, Express.js, HTTP, API, React.js, and responsive web design.
            ...
            <div className='col-sm-3' style={{width:'47%', backgroundImage:'linear-gradient(lightgray, white)', position: 'relative', bottom:'-30px',height:'98%', boxShadow:'-25px 25px 10px', float:'left'}}>
                    <section style={{backgroundImage:'linear-gradient(lightgray, white)',marginRight:'0px',marginLeft:'0px',
                    padding:'1.6px', minWidth:'500px',fontSize:'16px', maxHeight:'350px', position:'relative', zIndex:'4px', overflow:'scroll'}}>
